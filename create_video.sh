...
# CUDA_VISIBLE_DEVICES=0 python3 ./tortoise-tts/tortoise/read.py --textfile gpt_answer.txt --voice me --output_path ./result/voices --preset fast --kv_cache True --half True
conda deactivate 
